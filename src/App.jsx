...
function App() {
  ...
  // Tutup menu ketika resize window
  useEffect(() => {
    const handleResize = () => {
    ...
    >
      ...
      <section id="certificate" className="certificate" data-aos="fade-up">
        ...
        <div className="certificates">
          <a href={sertifikatIBMpdf1} target="_blank" rel="noopener noreferrer" className="card" data-aos="zoom-in">
            <img src={sertifikatIBMThumb1} alt="Sertifikat Classifying Data Using IBM Granite" className="certificate-img" />
            <h3>Sertifikat Classifying Data Using IBM Granite</h3>
            <p>Sertifikat dasar Klasifikasi Data.</p>
          </a>
          <a href={sertifikatIBMpdf2} target="_blank" rel="noopener noreferrer" className="card" data-aos="zoom-in">
            <img src={sertifikatIBMThumb2} alt="Sertifikat IBM Data Classification and Summarization" className="certificate-img" />
            <h3>Sertifikat IBM Data Classification and Summarization</h3>
            <p>Sertifikat Klasifikasi dan Ringkasan Data.</p>
          </a>
          <a href={KeterampilanKrusialDeveloperdiEraAIpdf} target="_blank" rel="noopener noreferrer" className="card" data-aos="zoom-in">
            <img src={sertifikatketerampilanThumb} alt="Sertifikat Keterampilan Krusial Developer di Era AI" className="certificate-img" />
